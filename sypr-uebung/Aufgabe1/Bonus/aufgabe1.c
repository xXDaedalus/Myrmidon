...
int main() {
    ...
    // Ausgabe des C-Datenmodells
        ...
        printf("Das Programm arbeitet mit dem C-Datenmodell ILP32.\n");
    #elif defined(__LP64__)
        printf("Das Programm arbeitet mit dem C-Datenmodell LP64.\n");
    #elif defined(__LLP64__)
        printf("Das Programm arbeitet mit dem C-Datenmodell LLP64.\n");
    #else
        printf("Das Programm arbeitet mit keinem der drei genannten C-Datenmodelle.\n");
    #endif
